...
#    dst_ol_dir = os.path.join('pynq_axi_examples', 'bitstream')
...
def copy_notebooks():
    src_nb_dir = os.path.join(repo_board_folder, 'files')
    dst_nb_dir = os.path.join(board_notebooks_dir, 'pynq_axi_examples')
...
setup(
    name="pynq_axi_examples",
    version='1.0',
    url='https://github.com/catherine-waechter/pynq_axi_examples.git',
